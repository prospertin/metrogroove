...
#import "MidiNoteUserCallback.h"

@implementation MidiNoteUserCallback
...
static OnNoteCallback _onNoteCallback = nil;

static void noteUserCallback (void *inClientData, MusicSequence inSequence, MusicTrack inTrack,
...
+ (void (*)(void *inClientData, MusicSequence inSequence, MusicTrack inTrack,
    ...
    return noteUserCallback;
}

+ (void)setNoteOnCallback:(OnNoteCallback)onCallback {
    _onNoteCallback = onCallback;
}
